...
var __context={"name":"sailib","loader":"SAI.GetSourceFromPaths","path":"src/sailib.sai","mtime":"2018-02-11T20:06:30.977Z","fetched":"2018-02-11T20:07:09.980Z"};
var _FS = require('fs');
var _G = {
  ct: 0
};
...
var $10g = prototype['isCollection'];
...
var $12g = prototype['assert'];
prototype['assert'] = function(p, _message) {
  var $_b, _msg, _Error, $17, _test = p,
    $ = this; {
    if (!(_test)) {
...
var $16g = prototype['kviterate_op'];
...
prototype['slice_op'] = function(p, _st, _ct) {
  var $_d, $_c, $303, $302, $300, $299, _v, _cache, $298, $297, $296, $295, $294, $293, $292, _keep, _only, _size, _crop, _skip, $291, $290, $289, $288, $287, $286, $285, $284, $283, $282, $281, $280, $279, $276, $275, $274, $273, $272, $271, $270, $269, $268, $267, $266, $265, $264, $263, $262, _len, $261, $260, $259, $258, $257, _a = p,
    ...
    if (($270 = ($.isString(_a)))) {
      ...
      throw new Error('Impossible code path 2 in slice_op');
    }
    if (($272 = ((_ct === 0)))) {
...
var $47g = prototype['expectsThrow'];
...
var $48g = prototype['finalizePrototype'];
prototype['finalizePrototype'] = function(p) {
  var $_d, $_c, $584, $583, _obj, $582, $581, $580, $579, $578, $575, $574, $573, $572, $571, $568, $567, $566, $565, $562, _proto = p,
    $ = this; {
    ...
    if (($582 = (_proto.__unverified))) {
      var $580 = _proto.__contracts;
      if (undefined === $580) $580 = [];
      for (var $579 in $580) {
        var $578 = $580[$579];
        if (($575 = ((undefined === _proto[$578])))) {
          throw new Error('SAI: Contractually required trait ' + $578 + ' does not exist in object ' + _proto.isa + '.');
        }
      }
    ...
    _proto.constructor = function(p) {
      {
        ...
        if (($583 = (_obj.Constructor))) {
          _obj.Constructor();;
        }
        if (($584 = (_obj.Instantiate))) {
...
var $49g = prototype['create_op_base'];
prototype['create_op_base'] = function(p, _parameters) {
  var $_d, $_c, $587, $586, _obj, _mod, _src, _fn, _proto, $585, _name = p,
    $ = this; {
...
var $50g = prototype['singleton_op'];
