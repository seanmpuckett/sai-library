...
var __context={"name":"sailib","loader":"SAI.GetSourceFromPaths","path":"src/sailib.sai","mtime":"2018-02-17T22:32:25.468Z","fetched":"2018-02-17T22:43:50.667Z"};
var _FS = require('fs');
var _GLOBAL = {
  instance: 0
};
...
prototype['create_op_base'] = function(p, _parameters) {
  var $_d, $_c, $588, $587, _obj, _mod, $586, _src, _fn, _proto, $585, _name = p,
    $ = this; {
    _proto = $._protocache[_name];
    if (!(_proto)) {
      _fn = (_name + '.js');
      _src = _FS.readFileSync(_fn, 'utf8');
      if (($586 = ($AI.slice_op((('#!' === _src)), 0, 2)))) {
        _src = _src.replace(/\#\![^\r\n\u0085\u2028\u2029]+/, '');
      }
    ...
    _obj = Object.create(_proto);
    if (($587 = (_obj.Constructor))) {
      _obj.Constructor();;
    }
    if (($588 = (_obj.Instantiate))) {
